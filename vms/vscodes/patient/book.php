...
?>
 <?php
                    ...
                    $mysqli=new mysqli('vms.crmthbjxciun.ap-south-1.rds.amazonaws.com','admin','sameep077','vms');
                    ...
                    if(empty($pet)){
                        ...
                        $query="INSERT INTO appointment (doctor_id,username, status, mobile, appointment_date, time_booked, pet_type, symptoms) VALUES('doctor','$username','pending','$mobile','$date','$timeslot','$pet','$sym')";
